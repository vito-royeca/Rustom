...
final class DriveLoader: ObservableObject {
    /// The scope required to read a user's Google Drive.
    static let driveReadScope = "https://www.googleapis.com/auth/drive.metadata.readonly"
    static let driveActivityReadScope = "https://www.googleapis.com/auth/drive.activity.readonly"
